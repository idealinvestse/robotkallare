...
# Clear log first, then run with output to both console and log file
echo "Starting GDial with logging at $(date)" > gdial.log
uvicorn app.api:app --host 0.0.0.0 --port 3003 --reload 2>&1 | tee -a gdial.log
