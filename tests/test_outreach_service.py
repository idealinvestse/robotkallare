...
class TestOutreachService:
    ...
    @pytest.fixture
    def mock_outreach_repo(self):
        """Create a mock outreach repository."""
        return Mock(spec=OutreachRepository)
    
    @pytest.fixture
    def outreach_service(self, mock_session, mock_contact_repo, mock_group_repo, mock_outreach_repo, mock_queue_publisher):
    ...
    def test_init(self, mock_session, mock_contact_repo, mock_group_repo, mock_outreach_repo, mock_queue_publisher):
        ...
        assert service.contact_repo == mock_contact_repo
        assert service.group_repo == mock_group_repo
        assert service.message_repo is not None
        assert service.outreach_repo == mock_outreach_repo
